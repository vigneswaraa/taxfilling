        ...
        <div class="container">
            <div class="page-banner1 row align-items-center">
                ...
                <div class="col-lg-6 col-lg-offset-2 col-12">
                    <h1 class="page-title">DIGITAL SIGNATURE CERTIFICATE(DSC)</h1>
                </div>
...
<p>Digital Signature Certificates (DSC) is the digital equivalent (that is electronic format) of physical or paper certificates. Examples of physical certificates are drivers’ licenses, passports or membership cards. Certificates serve as proof of identity of an individual for a certain purpose. There are three types of Digital Signatures, Class I, Class II and Class III Digital Signature.</p>
<p>Class I type of Digital Signatures : are only used for securing email communication.</p>
<p>Class II type of Digital Signatures : are used for Company or LLP Incorporation, IT Return E-Filing, Obtaining DIN or DPIN, and filing other forms with the Ministry of Corporate Affairs (MCA) and Income Tax Department.</p>
<p>Class III type Digital Signatures : are used mainly for E-Tendering and for participating in E-Auctions.</p>
<p>Digital Signatures come in the form of a USB E-Token, wherein the Digital Signature Certificate is stored in a USB Drive and can be accessed through a computer to sign documents electronically. A digital certificate can be presented electronically to prove your identity, to access information or services on the Internet or to sign certain documents digitally.</p>
                </div>
