        ...
        <div class="container">
            <div class="page-banner1 row align-items-center">
                ...
                <div class="col-lg-6 col-lg-offset-2 col-12">
                    <h1 class="page-title">PAN REGISTRATION</h1>
                </div>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="section-title title-white text-center col-12 mb-70">
                    <h1>PAN REGISTRATION FILING PROCESS</h1>
                    ...
                    <div class="timeline-wrap">
                        ...
                        <div class="timeline row">
                            ...
                            <div class="content col-md-6">
                                <h4>PAN CARD</h4>
                                <p>taxfiling.com will help you get Pan card within 15-20 days subject to government processing time.</p>
                            </div>
                        ...
                        <div class="timeline row">
                            ...
                            <div class="date col-md-6">
                                <span class="dot"></span>
                                <h4>Pan Application</h4>
                            </div>

                            <!-- Content -->
                            <div class="content col-md-6">
                                <h4>PAN APPLICATION</h4>
                                <p>taxfiling.com will collect necessary documents required for pan application in the provided format and the application will be submitted to NSDL for further processing.</p>
                            </div>
                        ...
                        <div class="timeline row">
                            ...
                            <div class="date col-md-6">
                                <span class="dot"></span>
                                <h4>PAN Application Processing at NSDL</h4>
                            </div>

                            <!-- Content -->
                            <div class="content col-md-6">
                                <h4>PAN APPLICATION PROCESSING AT NSDL</h4>
                                <p>Once your application is received, NSDL will verify the documents and process the same for issue of PAN card.</p>
                            </div>
                        ...
                        <div class="timeline row">
                            ...
                            <div class="date col-md-6">
                                <span class="dot"></span>
                                <h4>PAN Card Dispatch by NSDL</h4>
                            </div>

                            <!-- Content -->
                            <div class="content col-md-6">
                                <h4>PAN CARD DISPATCH BY NSDL</h4>
                                <p>Once, the application of PAN is processed by NSDL, the PAN Card will be dispatched to the address mentioned in application.</p>
                            </div>
