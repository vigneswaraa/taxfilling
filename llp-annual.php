        ...
        <div class="container">
            <div class="page-banner1 row align-items-center">
                ...
                <div class="col-lg-6 col-lg-offset-2 col-12">
                    <h1 class="page-title">LLP ANNUAL FILING</h1>
                </div>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="section-title title-white text-center col-12 mb-70">
                    <h1>LLP ANNUAL FILING FILING PROCESS</h1>
                    ...
                    <div class="timeline-wrap">
                        ...
                        <div class="timeline row">
                            ...
                            <div class="date col-md-6">
                                <span class="dot"></span>
                                <h4>LLP Annual Filing</h4>
                            </div>

                            <!-- Content -->
                            <div class="content col-md-6">
                                <h4>LLP ANNUAL FILING</h4>
                                <p>Annual filing of LLP is mandatorily to be filed with ROC every year. Allindiataxfiling.com assist you to maintain annual compliance with the Ministry of Corporate Affairs.</p>
                            </div>
                        ...
                        <div class="timeline row">
                            ...
                            <div class="content col-md-6">
                                <h4>ANNUAL RETURN PREPARATION</h4>
                                <p>Based on the financials and performance during the previous financial year, Allindiataxfiling.com Expert will prepare the Annual return of your LLP.</p>
                            </div>
                        ...
                        <div class="timeline row">
                            ...
                            <div class="content col-md-6">
                                <h4>ANNUAL RETURN VERIFICATION</h4>
                                <p>Once the Annual Return is prepared in the requisite format, the Client's can verify the prepared annual return and affix the digital signature.</p>
                            </div>
