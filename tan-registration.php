        ...
        <div class="container">
            <div class="page-banner1 row align-items-center">
                ...
                <div class="col-lg-6 col-lg-offset-2 col-12">
                    <h1 class="page-title">TAN REGISTRATION</h1>
                </div>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="section-title title-white text-center col-12 mb-70">
                    <h1>TAN REGISTRATION FILING PROCESS</h1>
                ...
                <div class="col-lg-12 col-12 ml-auto mr-auto">
                    <div class="timeline-wrap">
                        ...
                        <div class="timeline row">
                            ...
                            <div class="date col-md-6">
                                <span class="dot"></span>
                                <h4>TAN Application Processing at NSDL</h4>
                            </div>

                            <!-- Content -->
                            <div class="content col-md-6">
                                <h4>TAN APPLICATION PROCESSING AT NSDL</h4>
                                <p>Once your application is received, NSDL will verify the documents and process the same for issue of TAN.</p>
                            </div>
                        ...
                        <div class="timeline row">
                            ...
                            <div class="date col-md-6">
                                <span class="dot"></span>
                                <h4>TAN Dispatch by NSDL</h4>
                            </div>

                            <!-- Content -->
                            <div class="content col-md-6">
                                <h4>TAN DISPATCH BY NSDL</h4>
                                <p>Once the application and the attached supporting documents are verified, the Tax Department will allot a TAN Number for your business.</p>
                            </div>
