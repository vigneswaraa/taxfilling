        ...
        <div class="container">
            <div class="page-banner1 row align-items-center">
                ...
                <div class="col-lg-6 col-lg-offset-2 col-12">
                    <h1 class="page-title">INCOME TAX RETURN</h1>
                </div>
						...
						<h2 style="text-align:center">Enquire Form</h2>
                                <form  method="post">
                                    <div class="row row-5">
                                        ...
                                        <div class="col-md-12"><input type="submit" name="submit" value="send message"></div>
                                    </div>
                                </form>
                               <?php 
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="candidate-content col-lg-12 col-12 mb-30">               
                    ...
                    <p>It is a prescribed form through which the particulars of income earned by a person in a financial year and taxes paid on such income are communicated to the Income-tax Department. Different forms of returns of income are prescribed for filing of returns for different Status and Nature of income.</p>
                    <p>As an Individual you are required by law to file your Income Tax Returns, if your total income without allowing deductions (such as Section 80C etc.) exceeds the basic exemption limit. For Assessment Year 2017-18, the basic exemption limits are the following</p>
					<p>Individual resident aged below 60 years- Rs 2,50,000</p>
					<p>Individual resident who is of the age of 80 years or more- Rs 5,00,000</p>
                </div>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="section-title title-white text-center col-12 mb-70">
                    <h1>INCOME TAX RETURN FILING PROCESS</h1>
                    ...
                    <div class="timeline-wrap">
                        ...
                        <div class="timeline row">
                            ...
                            <div class="content col-md-6">
                                <h4>INCOME TAX RETURN (ITR)</h4>
                                <p>With advice of Allindiataxfiling.com Income Tax Expert, You will be assured with Timely and Accurate Income Tax Filing.</p>
                            </div>
                        ...
                        <div class="timeline row">
                            ...
                            <div class="content col-md-6">
                                <h4>DOCUMENT COLLECTION</h4>
                                <p>taxfiling.com Income Tax Expert will let you know the required documents, which you can easily mail to us anytime</p>
                            </div>
                        ...
                        <div class="timeline row">
                            ...
                            <div class="content col-md-6">
                                <h4>RETURN PREPARATION</h4>
                                <p>Based on the documents and information presented, an Allindiataxfiling.com Income Tax Expert will prepare your Income Tax Return and send for your approval.</p>
                            </div>
						...
						<!-- Single Timeline End -->
					     <div class="timeline row">
                            ...
                            <div class="content col-md-6">
                                <h4>RETURN FILING</h4>
                                <p>Once the Income Tax Return is verified and approved by you, our Income Tax expert will file your Income Tax Return with the Income Tax Department.</p>
                            </div>
