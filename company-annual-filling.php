        ...
        <div class="container">
            <div class="page-banner1 row align-items-center">
                ...
                <div class="col-lg-6 col-lg-offset-2 col-12">
                    <h1 class="page-title">COMPANY ANNUAL FILING</h1>
                </div>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="candidate-content col-lg-12 col-12 mb-30">               
                    <h1>COMPANY ANNUAL FILING</h1>
                    <p>All the companies doing business in India are required to file certain documents with the government authorities according to the requirements of the Companies Act of 2013 and other applicable laws. Annual filing of Returns and Balance sheet of companies is a part of Annual e-filling done with Registrar of Companies i.e, ROC.</p>
					<p>The Annual filing is compulsory for a Private Limited company, Public Limited Company, One Person Company and also for Limited Liability Partnership.</p>
					<p>An Annual filing consists of filing of Balance Sheet, Profit and Loss Account and Compliance Certificate. This Compliance Certificate would be applicable for those companies whose Paid-up Capital is more or equal to Rs. 10,00,000/- during the financial year. The Balance Sheet should be accompanied with Auditor’s Report, Cash flow Statement and Schedules to the Balance Sheet. This Balance Sheet and P&L account has to be signed by a Practicing Chartered Accountant along with his seal and Membership Number.</p>
			   </div>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="section-title title-white text-center col-12 mb-70">
                    <h1>COMPANY ANNUAL FILING FILING PROCESS</h1>
                    ...
                    <div class="timeline-wrap">
                        ...
                        <div class="timeline row">
                            ...
                            <div class="date col-md-6">
                                <span class="dot"></span>
                                <h4>Company Annual Filing</h4>
                            </div>

                            <!-- Content -->
                            <div class="content col-md-6">
                                <h4>COMPANY ANNUAL FILING</h4>
                                <p>taxfiling.com will collect necessary documents required for TAN application in the provided format and the application will be submitted to NSDL for further processing.</p>
                        ...
                        <div class="timeline row">
                            ...
                            <div class="date col-md-6">
                                <span class="dot"></span>
                                <h4>Annual Return Preparation</h4>
                            </div>

                            <!-- Content -->
                            <div class="content col-md-6">
                                <h4>ANNUAL RETURN PREPARATION</h4>
                                <p>Based on the financials and performance during the previous financial year Allindiataxfiling.com Expert will prepare the Annual return of your company.</p>
                            </div>
                        ...
                        <div class="timeline row">
                            ...
                            <div class="date col-md-6">
                                <span class="dot"></span>
                                <h4>Annual Return Verification</h4>
                            </div>

                            <!-- Content -->
                            <div class="content col-md-6">
                                <h4>ANNUAL RETURN VERIFICATION</h4>
                                <p>Once the Annual Return is prepared in the requisite format, the Client can verify the prepared annual return and affix the digital signature.</p>
                            </div>
						...
						<!-- Single Timeline End -->
						 <div class="timeline row">
                            ...
                            <div class="date col-md-6">
                                <span class="dot"></span>
                                <h4>Annual Return Upload</h4>
                            </div>

                            <!-- Content -->
                            <div class="content col-md-6">
                                <h4>ANNUAL RETURN UPLOAD</h4>
                                <p>Once DSC has been affixed then our expert will upload your return with Ministry of Corporate Affairs.</p>
                            </div>
