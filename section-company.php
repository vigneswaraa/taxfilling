...
<?php include('inc/header.php'); ?>
        ...
        <div class="container">
            <div class="page-banner1 row align-items-center">
                ...
                <div class="col-lg-6 col-lg-offset-2 col-12">
                    <h1 class="page-title">SECTION 8 COMPANY(NGO)</h1>
                </div>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="candidate-content col-lg-12 col-12 mb-30">               
                    <h1>SECTION 8 COMPANY(NGO)</h1>
                    <h3>"Section 8 Company Is The Preferred Choice Of Business For Charitable Business"</h3>
                    <p>A Section 8 Company is an organization  which is registered as a Non-Profit Organization (NPO). NPO/company has its objective of promotion of arts, commerce, charity, education, protection of environment, science, social welfare, sports, research, religion and intends to apply its profits, if any, or other income in promoting its objects. It functions exactly like a limited company including all the rights and obligations that come with such a company. However, it differs from a company in one very crucial aspect, i.e. it cannot use the words “Section 8” or “Limited” in its name.</p>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="section-title title-white text-center col-12 mb-70">
                    <h1>SECTION 8 COMPANY(NGO) FILING PROCESS</h1>
                    ...
                    <div class="timeline-wrap">
                        ...
                        <div class="timeline row">
                            ...
                            <div class="content col-md-6">
                                <h4>SECTION 8 COMPANY REGISTRATION</h4>
                                <p>taxfiling.com can incorporate a Section 8 Company in 18 to 20 days, subject to ROC processing time.</p>
                            </div>
                        ...
                        <div class="timeline row">
                            ...
                            <div class="content col-md-6">
                                <h4>OBTAINING DSC & DIN</h4>
                                <p>Digital Signature Certificate(DSC) and Director Identification Number(DIN) is required for the proposed Directors of the Section 8 Company, which can be obtained within 2 to 3 days.</p>
                            </div>
                        ...
                        <div class="timeline row">
                            ...
                            <div class="content col-md-6">
                                <h4>NAME APPROVAL</h4>
                                <p>A minimum of one and a maximum of six proposed names must be submitted to the MCA. Subject to availability, naming guidelines and MCA processing time, Name Approval can be obtained in 3 to 5 working days.</p>
                            </div>
                        ...
                        <div class="timeline row">
                            ...
                            <div class="content col-md-6">
                                <h4>LICENSE APPROVAL</h4>
                                <p>After the company’s name is approved, one needs to apply for a Section 8 Company license from the MCA.Approval can be obtained in 5-7 Working days.</p>
                            </div>
 ...
 <div class="timeline row">
                            ...
                            <div class="content col-md-6">
                                <h4>COMPANY REGISTRATION</h4>
                                <p>Registration documents can be submitted to the MCA along with an application for registration. MCA will usually approve the application for incorporation in 3 to 5 days, subject to their processing time.</p>
                            </div>
