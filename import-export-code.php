        ...
        <div class="container">
            <div class="page-banner1 row align-items-center">
                ...
                <div class="col-lg-6 col-lg-offset-2 col-12">
                    <h1 class="page-title">IMPORT EXPORT CODE</h1>
                </div>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="candidate-content col-lg-12 col-12 mb-30">               
                    ...
                    <p>Import Export (IE) Code is a registration required for persons importing or exporting goods and services from India. IE Code is issued by the Directorate General of Foreign Trade (DGFT), Ministry of Commerce and Industries, Government of India. IE Codes when issued can be used by the entity throughout its existence and doesn't require any renewal or filing. Therefore, it is recommended for most organizations to obtain IE Code, irrespective of if they need it at the moment.</p>
					<p>IE Code application must be made to the Directorate General of Foreign Trade along with the necessary supporting documents. Once, the application is submitted, DGFT will issue the IE Code for the entity in 15 - 20 working days or less. All importers who import goods are required to register Import export code and all exporters need this code to obtain the benefits of exports. IEC code holder does not require filing of any returns. IEC Code is issued for lifetime and requires no renewal. Even individuals who are proprietors can obtain the code in their name. It is not necessary to setup a business for the same.</p>
                </div>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="section-title title-white text-center col-12 mb-70">
                    <h1>IMPORT EXPORT CODE FILING PROCESS</h1>
                    ...
                    <div class="timeline-wrap">
                        ...
                        <div class="timeline row">
                            ...
                            <div class="date col-md-6">
                                <span class="dot"></span>
                                <h4>Import Export Code Registration</h4>
                            </div>

                            <!-- Content -->
                            <div class="content col-md-6">
                                <h4>IMPORT EXPORT CODE REGISTRATION</h4>
                                <p>taxfiling.com can Register for Import Export Code in 18 to 20 days, subject to DGFT processing time.</p>
                            </div>
                        ...
                        <div class="timeline row">
                            ...
                            <div class="date col-md-6">
                                <span class="dot"></span>
                                <h4>IEC Application</h4>
                            </div>

                            <!-- Content -->
                            <div class="content col-md-6">
                                <h4>IEC APPLICATION</h4>
                                <p>We draft your IEC application and file it with the DGFT office on your behalf.</p>
                            </div>
                        ...
                        <div class="timeline row">
                            ...
                            <div class="content col-md-6">
                                <h4>IEC FEE PAYMENT</h4>
                                <p>We pay the IEC government free and follow up with department for your license.</p>
                            </div>
                        ...
                        <div class="timeline row">
                            ...
                            <div class="content col-md-6">
                                <h4>REGISTRATION APPROVAL</h4>
                                <p>Once your IEC registration is completed we will send IEC license to you.</p>
                            </div>
