        ...
        <div class="container">
            <div class="page-banner1 row align-items-center">
                ...
                <div class="col-lg-6 col-lg-offset-2 col-12">
                    <h1 class="page-title">TRADEMARK REGISTRATION</h1>
                </div>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="section-title title-white text-center col-12 mb-70">
                    <h1>TRADEMARK REGISTRATION FILING PROCESS</h1>
                    ...
                    <div class="timeline-wrap">
                        ...
                        <div class="timeline row">
                            ...
                            <div class="content col-md-6">
                                <h4>TRADEMARK REGISTRATION</h4>
                                <p>taxfiling can provide you ™ within 1 day</p>
                            </div>
                        ...
                        <div class="timeline row">
                            ...
                            <div class="content col-md-6">
                                <h4>TRADEMARK SEARCH</h4>
                                <p>We first run a trademark search to check whether your unique name or logo is Available for Registration or one sounding very similar to it has already been taken.</p>
                            </div>
                        ...
                        <div class="timeline row">
                            ...
                            <div class="content col-md-6">
                                <h4>TRADEMARK FILING</h4>
                                <p>After Completing Search for Trademark,our lawyers can file trademark application on your behalf.</p>
                            </div>
                        ...
                        <div class="timeline row">
                            ...
                            <div class="content col-md-6">
                                <h4>TRADEMARK REGISTRATION</h4>
                                <p>Once the Application is Submitted ,you can start using ™</p>
                            </div>
